    ...
    <div className='container login-container mt-5'>
      <h1 className='text-center text-danger fw-bold'>Login</h1>
       <form id='register' onSubmit={handleLogin}>
          ...
          <div className='mt-4'>
            <a className='my-2 d-block' href="">Forget Password</a>
            <button type="submit"  className='btn btn-primary form-control'>Login</button>
            <button type="submit" className='btn btn-primary form-control mt-2' onClick={handleProviderLogin}>Continue With Google <span className='googleIcon'><FcGoogle/></span></button>
          </div>
        </form>
    </div>
  )
